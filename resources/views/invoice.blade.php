        ...
        <div class="inv-header">
            <div>
                ...
                <ul>
                    ...
                    <li>+91 1234567890 | carrental@gmail.com</li>
                </ul>
                <h2>Client</h2>
                <ul>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>INR {{ $reservation->price_per_day * 10 }}</td>
                        <td>INR {{ $reservation->total_price * 10 }}</td>
                    </tr>
        ...
        <div class="inv-footer">
            ...
            <div>
                <table>
                    ...
                    <tr>
                        <th>tax (15%)</th>
                        <td>INR {{ ($reservation->total_price * 10) * 0.15 }}</td>
                    </tr>
                    <tr>
                        <th style="color: #ff9b00">Total to pay</th>
                        <td>INR {{ ($reservation->total_price * 10) + (($reservation->total_price * 10) * 0.15) }}</td>
                    </tr>
                </table>
            </div>
